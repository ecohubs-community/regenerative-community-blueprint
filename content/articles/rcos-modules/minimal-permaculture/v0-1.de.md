...
Wenn ökologische Systeme systemkritisch werden oder erheblich skalieren, SHOULD dieses Modul durch das vollständige Permakultur-Modul ersetzt werden.
...
Die Gemeinschaft MUST ausdrücklich festlegen:
...
Ökologische Pflege MAY zugewiesen werden über:
- eine einzelne rotierende Hüter*innen-Rolle, oder
- eine gemeinsame Pflegevereinbarung.

Mindestens MUST die Gemeinschaft festlegen:
...
Die Gemeinschaft MUST explizit, aber einfach beantworten:
...
Wenn Arbeit erwartet wird, MUST Pflegearbeit:
- sichtbar,
- besprechbar,
...
Alltägliche ökologische Entscheidungen MAY von den aktuellen Hüter*innen getroffen werden.

Strukturelle Entscheidungen (z. B. Gärten erweitern, Bäume entfernen, Landnutzung festschreiben) MUST:
...
- MUST NOT durch Pflege oder Investition privatisiert werden,
- MUST durch die Gemeinschaft rückholbar bleiben,
- MUST einen Ausstiegspfad sowohl für Pflegende als auch für Nicht-Pflegende haben.

Wenn Eigentum besteht, MUST Nutzungsrechte explizit geregelt sein.
...
Folgendes MAY ausreichend sein:
...
Dieses Modul MUST NOT außer Kraft setzen:
